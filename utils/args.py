# From Wang-ML-Lab/bayesian-peft (MIT License).
# Source: https://github.com/Wang-ML-Lab/bayesian-peft/tree/main/utils
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional WandB account or team name. Defaults to the authenticated account."
    )
    parser.add_argument(
        "--wandb-project",
        type=str,
