...
# Ensure project root is on sys.path so we import the local utils module.
...
class WrapperBase(PeftModel):
    ...
    def __init__(
        ...
        # Prefer explicit warmup_steps if provided; otherwise use ratio.
        warmup_steps = args.warmup_steps if args.warmup_steps > 0 else num_training_steps * args.warmup_ratio
